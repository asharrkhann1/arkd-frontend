                ...
                <div className="flex-1 p-8 md:p-14 lg:p-16 flex flex-col gap-8">
                    <div>
                        ...
                        <p className="text-[15px] text-slate-400">
                            Already have an account? <Link href="/login" className="text-blue-500 font-medium hover:text-blue-400 transition-colors">Login here</Link>.
                        </p>
                    </div>
                    ...
                    <div className="flex flex-col gap-4">
                        <input
                            ...
                            className="w-full p-4 bg-black/60 border border-blue-500/30 rounded-xl text-[15px] text-slate-100 placeholder-slate-500 focus:outline-none focus:bg-black/80 focus:border-blue-500/60 focus:ring-[3px] focus:ring-blue-500/15 transition-all duration-300"
                        />
                        <input
                            type="email"
                        ...
                        <div className="relative">
                            <input
                                ...
                                className="w-full p-4 bg-black/60 border border-blue-500/30 rounded-xl text-[15px] text-slate-100 placeholder-slate-500 focus:outline-none focus:bg-black/80 focus:border-blue-500/60 focus:ring-[3px] focus:ring-blue-500/15 transition-all duration-300 pr-12"
                            />
                            <button
                                type="button"
                        ...
                        <button className="group w-full flex items-center justify-center gap-2 p-4 bg-gradient-to-br from-blue-500 to-blue-600 text-white font-semibold text-base rounded-xl shadow-[0_4px_16px_rgba(59,130,246,0.3)] hover:from-blue-600 hover:to-blue-700 hover:-translate-y-0.5 hover:shadow-[0_8px_24px_rgba(59,130,246,0.4)] transition-all duration-300">
                            Create Account
